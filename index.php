      ...
      <div class="row">
        ...
        <div class="col-md-5">
          ...
          <div class="p-4 mb-3 bg-white">
            ...
            <p class="mb-4">Thoppupalayam, Kumaran Nagar, Perundurai, Tamil Nadu 638060</p>

            <p class="mb-0 font-weight-bold">Phone</p>
            <p class="mb-4"><a href="#">+91 93446-11806</a></p>

            <p class="mb-0 font-weight-bold">Email Address</p>
            <p class="mb-0"><a href="#">mohanramm.21it@kongu.edu</a></p>
